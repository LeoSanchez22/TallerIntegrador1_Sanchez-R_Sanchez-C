...
export default function ModelPerformance({ modelSummary }: ModelPerformanceProps) {
  ...
  return (
    <div className="bg-white dark:bg-neutral-900/40 backdrop-blur-md rounded-xl p-6 border border-neutral-200 dark:border-neutral-800 shadow-sm transition-all duration-200">
      <div className="mb-6">
        <h2 className="text-xl font-bold text-neutral-900 dark:text-white mb-2">Machine Learning Performance Summary</h2>
        <p className="text-sm text-neutral-500 dark:text-neutral-400">Indicadores de rendimiento para los motores de Machine Learning</p>
      </div>
      <div className="space-y-4">
        ...
        <div className="p-4 bg-neutral-50 dark:bg-neutral-950 rounded-lg border border-neutral-200 dark:border-neutral-800/40">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-neutral-500 dark:text-neutral-400 font-semibold">ML Engine Status</span>
            <span className="text-sm font-bold text-green-600">{modelSummary?.status || 'Healthy (Machine Learning)'}</span>
          </div>
          <div className="w-full bg-neutral-200 dark:bg-neutral-800 rounded-full h-2">
